/**
 * APP.JS - Initialisation avec sidebar collapsible fidèle à l'original
 */
const App = {
  config: { name: 'Cyrias Buddy', version: '1.0', theme: 'light' },

  // SVG icons pour la sidebar (les mêmes que l'original v23)
  icons: {
